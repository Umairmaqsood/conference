...
<main class="main">
      ...
      >
        <div class="container position-relative">
          <h1 style="color:white">Support Service Committee</h1>
          
          <nav class="breadcrumbs">
            <ol>
              <li><a href="index.php">Home</a></li>
              <li class="current">Support Service Committee</li>
            </ol>
          </nav>
        </div>
      </div>
              ...
              <div class="details">
                ...
                Foundation University Islamabad is organizing its first international conference
                 ...
                 Science and Technology. The conference will bring together Government, industry,
                  ...
                  communication engineering. FICSE aims to bring together researchers, practitioners
                   and experts from academia and industry to focus on recent global advancement.
                </p>
