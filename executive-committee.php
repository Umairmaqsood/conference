...
<main class="main">
    ...
    >
        <div class="container position-relative">
            <h1 style="color:white">Executive Committee</h1>
   ...
   <div class="container" data-aos="fade-up" data-aos-delay="100">   
     ...
     <h2>Conference Chair<br /></h2>
           ...
           <div class="col-xl-6 col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="100" style="text-align:center">
               <div class="member">
               <div class="container section-title" data-aos="fade-up">
     <h2>Conference Co-Chair<br /></h2>
   </div>
                   <img src="assets/img/speakers/shariq.jpeg" class="img-fluid rounded-circle" alt="" style="width: 320px; height: 320px; object-fit: cover;" />
                   <div class="member-info">
                       <div class="member-info-content">
                           <h4>
                           Dr. Shariq Hussain
       ...
       <div class="row gy-4">
           <div class="col-xl-4 col-lg-4 col-md-4" data-aos="fade-up" data-aos-delay="100" style="text-align:center">
               <div class="member">
                   ...
                   <img src="assets/img/speakers/sajid.jpeg" class="img-fluid rounded-circle" alt="" style="width: 320px; height: 320px; object-fit: cover;" />
                   <div class="member-info">
                       <div class="member-info-content">
                           <h4>
                           Dr. Sajid Ali Khan
           ...
           <div class="col-xl-4 col-lg-4 col-md-4" data-aos="fade-up" data-aos-delay="100" style="text-align:center">
               <div class="member">
                   ...
                   <img src="assets/img/speakers/rehman.jpg" class="img-fluid rounded-circle" alt="" style="width: 320px; height: 320px; object-fit: cover;" />
                   <div class="member-info">
                       <div class="member-info-content">
                           <h4>
                           Dr. Engr. Abdur Rehman
                           </h4>
                           <h5>
                           HOD EE, FUSST
                           </h5>
           ...
           <div class="col-xl-4 col-lg-4 col-md-4" data-aos="fade-up" data-aos-delay="100" style="text-align:center">
               <div class="member">
                   ...
                   <img src="assets/img/speakers/ateeq.png" class="img-fluid rounded-circle" alt="" style="width: 320px; height: 320px; object-fit: cover;" />
                   <div class="member-info">
                       <div class="member-info-content">
                           <h4>
                           Dr. Ateeq Ur Rehman
    ...
    <div class="container section-title" data-aos="fade-up">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <div class="row justify-content-center gy-4">
                <div class="col-xl-6 col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="100" style="text-align:center">
                    <div class="member">
                        <img src="assets/img/speakers/sajid.jpeg" class="img-fluid rounded-circle" alt="" style="width: 340px; height: 340px; object-fit: cover;" />
                        <div class="member-info">
                            <div class="member-info-content">
                            <h4>
                                Dr. Sajid Ali Khan
